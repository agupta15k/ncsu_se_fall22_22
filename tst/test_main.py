...
def test_main(monkeypatch, capsys):
    ...
    def mockPerformComputation(operation, num1, num2):
        return 3.0
    monkeypatch.setattr('src.main.getInputOperation', mockGetInputOperation)
    monkeypatch.setattr('src.main.getInputValuesForOperation', mockGetInputValuesForOperation)
    monkeypatch.setattr('src.main.performComputation', mockPerformComputation)
...
def test_getInputValuesForOperationNoLastResult(monkeypatch):
    def mockGetNumber(operation, lastResult):
        return 3.7
    monkeypatch.setattr('src.main.getNumber', mockGetNumber)
...
def test_getNumberValidInputInt(monkeypatch):
    ...
    monkeypatch.setattr('src.main.validateNum', mockValidateNum)
